...
def main():
    ...
    with st.sidebar:
        ...
        model_options = {
            "qwen(32b)": "groq:qwen-2.5-32b",
            "qwen(coder-32b)": "groq:qwen-2.5-coder-32b",
            "qwen(qwq-32b)": "groq:qwen-qwq-32b",\
            "deepseek-r1(32b)": "groq:deepseek-r1-distill-qwen-32b",
            "deepseek-r1(70b)": "groq:deepseek-r1-distill-llama-70b",
            "google": "groq:gemma2-9b-it",
            "huggingface": "groq:distil-whisper-large-v3-en",
            "llama-3.1(8b-instant)": "groq:llama-3.1-8b-instant",
            "llama-3.2(11b-vision-preview)": "groq:llama-3.2-11b-vision-preview",
            "llama-3.2(1b-preview)": "groq:llama-3.2-1b-preview",
            "llama-3.2(3b-preview)": "groq:llama-3.2-3b-preview",
            "llama-3.2(90b-vision-preview)": "groq:llama-3.2-90b-vision-preview",
            "llama-3.3(70b-specdec)": "groq:llama-3.3-70b-specdec",
            "llama-3.3(70b-versatile)": "groq:llama-3.3-70b-versatile",
            "llama-guard(8b)": "groq:llama-guard-3-8b",
            "llama3(70b)": "groq:llama3-70b-8192",
            "llama3(8b)": "groq:llama3-8b-8192",
            "llama4(instruct)": "groq:meta-llama/llama-4-scout-17b-16e-instruct",
            "mistralai": "groq:mistral-saba-24b",
            "openai": "groq:whisper-large-v3",
            "openai-turbo": "groq:whisper-large-v3-turbo",
            "playai": "groq:playai-tts",
            "sdaia": "groq:allam-2-7b",
        }
        ################################################################
        # Model selection
        ################################################################
        selected_p_x = st.selectbox(
            ...
            index=list(model_options.keys()).index("deepseek-r1(70b)"),
            key="model_p1",
        )
        selected_p_o = st.selectbox(
            "Select Player O",
            list(model_options.keys()),
            index=list(model_options.keys()).index("llama-3.3(70b-versatile)"),
            key="model_p2",
        )
